...
$pyScript = Join-Path $PSScriptRoot 'audit_figure5_comparator_replay_feasibility_v0_1_1.py'
...
Write-Host '============================================================'
Write-Host ' CMDO FIGURE 5 COMPARATOR-REPLAY FEASIBILITY AUDIT v0.1.1'
Write-Host ' gzip-safe canonical inspection'
Write-Host '============================================================'
...
Write-Host "`n[1] Running feasibility audit"
& $python.Source @argsList
if ($LASTEXITCODE -ne 0) {
    throw "Comparator replay feasibility audit v0.1.1 failed with code $LASTEXITCODE"
}

$outDir = Join-Path $repo 'source_data\figure5_final_system\comparator_replay_feasibility'
$csvPath = Join-Path $outDir 'CMDO_Figure5_Comparator_Replay_Feasibility_v0.1.1.csv'
$jsonPath = Join-Path $outDir 'CMDO_Figure5_Comparator_Replay_Feasibility_v0.1.1.json'
