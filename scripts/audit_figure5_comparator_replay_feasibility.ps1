...
$pyScript = Join-Path $PSScriptRoot 'audit_figure5_comparator_replay_feasibility.py'
...
Write-Host '============================================================'
Write-Host ' CMDO FIGURE 5 COMPARATOR-REPLAY FEASIBILITY AUDIT'
Write-Host ' U5 development -> U6 cross-domain -> U7 clinical'
Write-Host '============================================================'
...
if ($LASTEXITCODE -ne 0) {
    throw "Comparator replay feasibility audit failed with code $LASTEXITCODE"
}

$outDir = Join-Path $repo 'source_data\figure5_final_system\comparator_replay_feasibility'
$csvPath = Join-Path $outDir 'CMDO_Figure5_Comparator_Replay_Feasibility_v0.1.csv'
$jsonPath = Join-Path $outDir 'CMDO_Figure5_Comparator_Replay_Feasibility_v0.1.json'
