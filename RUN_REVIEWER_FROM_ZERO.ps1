...
Write-Host "Readiness   : $($Report.reviewer_readiness)"
Write-Host "U2 numeric  : $($Report.fresh_u2_tolerance_comparison)"
Write-Host "U2 advisory : $($Report.fresh_u2_numeric_advisory_class)"
Write-Host "Threshold   : $($Report.fresh_u2_threshold_selection_diagnostic)"
Write-Host "Frozen-thr BA: $($Report.fresh_u2_frozen_threshold_balanced_accuracy_passed)/$($Report.fresh_u2_frozen_threshold_balanced_accuracy_total) within tolerance"
Write-Host "U2 metrics  : $($Report.fresh_u2_metric_comparisons_passed)/$($Report.fresh_u2_metric_comparisons_total) within tolerance"
