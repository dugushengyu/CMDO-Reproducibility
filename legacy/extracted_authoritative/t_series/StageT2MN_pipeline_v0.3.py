...
RUNTIME_REVISION = "StageT2-MN-v0.3-self-contained-no-notebook-file-dependency"
EMBEDDED_PAYLOAD_SHA256 = globals().get("EMBEDDED_PAYLOAD_SHA256", "")
assert re.fullmatch(r"[0-9a-f]{64}", EMBEDDED_PAYLOAD_SHA256), "Embedded payload SHA256 was not supplied by the self-contained launcher."
...
required = [
    MERGED_PREREG_PATH, MERGED_METHOD_PATH, PERSISTENCE_REVIEW_PATH, REGISTRY_PATH, README_PATH,
...
entry_payload = {
    ...
    "embedded_pipeline_payload_sha256": EMBEDDED_PAYLOAD_SHA256,
